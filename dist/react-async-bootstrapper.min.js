...
function asyncBootstrapper(t, e) {
  ...
  return reactTreeWalker(
    ...
    function(t, e) {
      if (
        e &&
        ('function' == typeof e.asyncBootstrap ||
          'function' == typeof e.bootstrap)
      )
        return 'function' == typeof e.bootstrap
          ? e.bootstrap()
          : console.log(warnmsg) || e.asyncBootstrap()
    },
    Object.assign({}, o, defaultContext),
    e,
  )
}
